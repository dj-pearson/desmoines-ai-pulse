...
- [x] **Task:** Design and document the enhanced user profile schema. (0084934)
- [x] **Task:** Write and apply database migrations to update the user_profiles and ecommendation_scores tables. (b52b46c)
