...
```typescript
const bottomActionsPattern = /<div[^>]*class=["'][^"']*bottom-actions[^"']*["'][^>]*>([\s\S]*?)<\/div>/i;
...
```html
<div class="bottom-actions">
  <a href="https://desmoinesartcenter.org/art/exhibitions/iowa-artists-2025-ben-millett/" 
     target="_blank" 
     class="action-item">
    <i aria-hidden="true" class="fas fa-external-link-alt"></i>
    Visit Website
...
```html
<div class="bottom-actions">
  <a href="https://www.facebook.com/events/venue/event-name/12345/" 
     target="_blank" 
     class="action-item">
    Visit Website
  </a>
...
<div class="bottom-actions">
  ...
  <a href="https://venue.com/events/concert" target="_blank" class="action-item">
    Visit Website
  </a>
