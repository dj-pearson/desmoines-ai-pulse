 ...
 * Risk level: LOW (records milestones + optional recognition email; opt-out
 *   respected, frequency-capped, quality-gated).
 *
 * agent-milestones (AOS-NURTURE-006) — loyalty / streak / milestone recognition.
 *
