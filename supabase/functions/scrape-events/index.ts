...
const mockScrapedEvents = [
  {
    ...
    original_description: "Annual art festival featuring local artists and live music in downtown Des Moines.",
  ...
  },
  {
    ...
    original_description: "Triple-A baseball game featuring the Iowa Cubs vs. Nashville Sounds.",
  ...
  },
  {
    ...
    original_description: "Weekly farmers market with local produce, crafts, and food vendors.",
        ...
        const openaiResponse = await fetch('https://api.openai.com/v1/chat/completions', {
          ...
          body: JSON.stringify({
            ...
            messages: [
              {
                role: 'system',
                content: 'You are a helpful assistant that enhances event descriptions for a Des Moines events website. Make descriptions engaging, informative, and locally relevant.'
              },
              {
                role: 'user',
