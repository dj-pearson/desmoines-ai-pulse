 ...
 * Risk level: MEDIUM (reads security signals, opens incident tasks — never locks
 *   a user or takes destructive action).
 *
 * agent-security-monitor (AOS-SEC-001) — Security Anomaly Detector
 *
...
Deno.serve(async (req) => {
  ...
  // Budgeted, audited, kill-switch aware via the agent run wrapper.
