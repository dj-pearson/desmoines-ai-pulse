 ...
 * Risk level: MEDIUM (sends replies to users on high confidence; every send and
 *   escalation is audited; sensitive topics + human requests always escalate;
 *   frequency limits prevent ping-pong).
 *
