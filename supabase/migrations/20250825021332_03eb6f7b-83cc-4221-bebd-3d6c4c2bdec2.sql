-- Create competitor analysis tables
...
CREATE OR REPLACE FUNCTION public.update_competitor_updated_at_column()
RETURNS TRIGGER AS $$
BEGIN
  NEW.updated_at = now();
  RETURN NEW;
...
CREATE TRIGGER update_competitors_updated_at
  ...
  FOR EACH ROW
  EXECUTE FUNCTION public.update_competitor_updated_at_column();
