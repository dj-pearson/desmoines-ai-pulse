-- WEB-AUTO-005: schedule the weekly duplicate-detection + merge job (Mon 03:15 UTC,
-- off-peak and after the nightly data-quality heal). Mirrors the cron pattern used by
-- the other WEB-AUTO jobs (20260612000003 / 20260612000006).
DO $$
BEGIN
