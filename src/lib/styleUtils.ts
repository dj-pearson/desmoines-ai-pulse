...
export const cardStyles = {
  ...
  premium:
    "bg-white/95 backdrop-blur-sm shadow-2xl rounded-3xl overflow-hidden border-0",

  // Standard card with modern styling
  standard:
    "bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-100",
  ...
  interactive:
    "bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1",
};
...
export const heroSections = {
  ...
  restaurant: {
    container:
      "relative h-80 bg-gradient-to-r from-amber-600 via-orange-500 to-red-500 overflow-hidden",
  ...
  event: {
    container:
      "relative h-80 bg-gradient-to-r from-blue-600 via-purple-500 to-pink-500 overflow-hidden",
    overlay: "absolute inset-0 bg-black/20",
    content: "absolute inset-0 flex items-center justify-center",
    title: "text-5xl font-bold mb-2 tracking-tight text-white",
  },
  ...
  attraction: {
    container:
      "relative h-80 bg-gradient-to-r from-green-600 via-emerald-500 to-teal-500 overflow-hidden",
    overlay: "absolute inset-0 bg-black/20",
    content: "absolute inset-0 flex items-center justify-center",
    title: "text-5xl font-bold mb-2 tracking-tight text-white",
  },
...
export const buttonStyles = {
  ...
  // Secondary button
  secondary:
    "bg-white/80 backdrop-blur-sm border border-gray-200 hover:bg-gray-50 px-6 py-3 rounded-lg font-medium transition-all duration-300",

  // Outline button
  outline:
    "border-2 border-current bg-transparent hover:bg-current hover:text-white px-6 py-3 rounded-lg font-medium transition-all duration-300",
};
...
export const createDetailCard = (
  type: "restaurant" | "event" | "attraction"
) => {
