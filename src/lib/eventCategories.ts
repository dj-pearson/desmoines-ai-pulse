 ...
 * the edge functions, this bundle, the Python crawler, and the backfill
 * migration. This file and its JSON mirror
 * supabase/functions/_shared/eventCategories.{ts,json}; scripts/check-event-categories.mjs
 ...
 */
import data from "./eventCategories.json";
