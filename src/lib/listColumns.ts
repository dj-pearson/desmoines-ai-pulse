...
export const EVENT_LIST_COLUMNS =
  "ai_writeup, archived_at, category, city, created_at, date, enhanced_description, event_start_local, event_start_utc, event_timezone, id, image_url, is_enhanced, is_featured, is_sponsored, sponsored_until, latitude, location, longitude, original_description, price, source_url, title, updated_at, venue, writeup_generated_at";
