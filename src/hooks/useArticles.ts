...
export const useArticles = (options?: { autoLoad?: boolean }) => {
  ...
  const loadArticles = async (status?: string) => {
    try {
      ...
      log.error('Error loading articles', { action: 'loadArticles', metadata: { error: err } });
  ...
  const getArticleBySlug = async (slug: string): Promise<Article | null> => {
    try {
      ...
      log.error('Error getting article by slug', { action: 'getArticleBySlug', metadata: { error: err } });
      setError(err.message);
      return null;
    }
  };
  ...
  const createArticle = async (articleData: CreateArticleData): Promise<Article | null> => {
    try {
      ...
      log.error('Error creating article', { action: 'createArticle', metadata: { error: err } });
      setError(err.message);
      toast({
  ...
  const updateArticle = async (articleData: UpdateArticleData): Promise<Article | null> => {
    try {
      ...
      log.error('Error updating article', { action: 'updateArticle', metadata: { error: err } });
      setError(err.message);
      toast({
  ...
  const deleteArticle = async (id: string): Promise<boolean> => {
    try {
      ...
      log.error('Error deleting article', { action: 'deleteArticle', metadata: { error: err } });
      setError(err.message);
      toast({
  ...
  const publishArticle = async (id: string): Promise<boolean> => {
    try {
      ...
      log.error('Error publishing article', { action: 'publishArticle', metadata: { error: err } });
      setError(err.message);
      toast({
  ...
  const generateArticleFromSuggestion = async (suggestionId: string, customPrompt?: string): Promise<Article | null> => {
    try {
      ...
      log.error('Error generating article', { action: 'generateArticle', metadata: { error: err } });
      setError(err.message);
      toast({
