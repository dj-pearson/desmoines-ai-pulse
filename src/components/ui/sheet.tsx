...
interface SheetContentProps
  ...
  /** Omit the built-in 16px corner close button, for callers that render
   *  their own (MobileNav). Two close buttons read as two exits to a screen
   *  reader, and the built-in one is below the 44px touch target. */
  hideClose?: boolean
}
