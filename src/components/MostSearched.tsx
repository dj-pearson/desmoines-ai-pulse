        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-4">
              {(trending.restaurants.length > 0 ? trending.restaurants : [])
                .slice(0, 3)
                .map((item) => {
                  ...
                  return (
                    <Card
                      ...
                      onClick={() =>
                        handleItemClick("restaurant", restaurant.id)
                      }
                    >
          ...
          <div>
            ...
            <div className="space-y-4">
              {(trending.attractions.length > 0 ? trending.attractions : [])
                .slice(0, 3)
                .map((item) => {
                  ...
                  return (
                    <Card
                      ...
                      className="hover:shadow-md transition-shadow cursor-pointer"
                      onClick={() =>
                        handleItemClick("attraction", attraction.id)
                      }
                    >
                      <CardHeader className="pb-3">
                        <div className="flex justify-between items-start">
          ...
          <div>
            ...
            <div className="space-y-4">
              {(trending.playgrounds.length > 0 ? trending.playgrounds : [])
                .slice(0, 3)
                .map((item) => {
                  ...
                  return (
                    <Card
                      ...
                      className="hover:shadow-md transition-shadow cursor-pointer"
                      onClick={() =>
                        handleItemClick("playground", playground.id)
                      }
                    >
                      <CardHeader className="pb-3">
                        <div className="flex justify-between items-start">
