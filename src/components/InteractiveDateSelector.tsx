          ...
          <div className="p-4 space-y-4">
            ...
            {mode === 'single' && (
              <Calendar
                ...
                className={cn("p-3 pointer-events-auto border border-border rounded-lg")}
                ...
                classNames={{
                  ...
                  nav_button: cn(
                    "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 text-foreground border border-border rounded-md hover:bg-accent"
                  ),
                  ...
                  day: cn(
                    "h-8 w-8 p-0 font-normal aria-selected:opacity-100 hover:bg-accent hover:text-accent-foreground rounded-md border border-transparent",
                  ...
                  day_today: "bg-accent text-accent-foreground border-accent",
