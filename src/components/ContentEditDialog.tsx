...
const fieldConfigs = {
  ...
  hotel: {
    fields: [
      ...
      { key: "affiliate_provider", label: "Affiliate Provider", type: "select", options: ["Partnerize", "Awin", "Commission Junction", "Booking.com", "Hotels.com", "TripAdvisor", "Direct", "Other"] },
      { key: "image_url", label: "Image URL", type: "url" },
      ...
      { key: "chain_name", label: "Chain/Sub-Brand", type: "text" },
      { key: "brand_parent", label: "Brand Parent Company", type: "select", options: ["Hilton", "Marriott", "IHG", "Hyatt", "Choice", "Wyndham", "Best Western", "Drury", "Independent"] },
