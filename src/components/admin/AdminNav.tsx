...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Agents", href: "/admin/agents", icon: Bot, description: "Autonomous agent control plane" },
      ...
      { label: "Support console", href: "/admin/support", icon: Headset, description: "Tier-2/3 ticket workspace" },
      { label: "Support tickets", href: "/admin/support-tickets", icon: LifeBuoy, description: "Classified tickets, SLA, corrections" },
