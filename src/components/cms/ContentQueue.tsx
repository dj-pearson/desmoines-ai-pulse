...
export function ContentQueue() {
  ...
  const loadQueueItems = async () => {
    try {
      ...
      log.error('Error loading queue', { action: 'loadQueueItems', metadata: { error } });
  ...
  const loadComments = async (queueItemId: string) => {
    try {
      ...
      log.error('Error loading comments', { action: 'loadComments', metadata: { error } });
    }
  };
  ...
  const handleStatusChange = async (newStatus: QueueItem['status']) => {
    ...
    try {
      ...
      log.error('Error updating status', { action: 'handleStatusChange', metadata: { error } });
  ...
  const handleAddComment = async () => {
    ...
    try {
      ...
      log.error('Error adding comment', { action: 'handleAddComment', metadata: { error } });
  ...
  const handlePriorityChange = async (priority: number) => {
    ...
    try {
      ...
      log.error('Error updating priority', { action: 'handlePriorityChange', metadata: { error } });
