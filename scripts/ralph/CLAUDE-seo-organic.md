...
3. You must be on branch `claude/seo-phase2-content`, cut from `main`. If you are not on it, check it out. Never commit to `main` or `develop`. Never force-push any protected branch.
