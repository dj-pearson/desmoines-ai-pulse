...
3. You must be on branch `claude/seo-organic-2026-08-31`, cut from `main`. If you are not on it, check it out. Never commit to `main` or `develop`. Never force-push any protected branch.
